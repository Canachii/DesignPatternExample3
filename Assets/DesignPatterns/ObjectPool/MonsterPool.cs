...
public class MonsterPool : MonoBehaviour
{
    ...
    private GameObject[] monsterPool; // 몬스터에 대한 배열(몬스터 풀)

    private GameObject monsterSpawnPool;
    ...
    private void Spawn(GameObject[] gameObjects, int poolSize)
    {
    ...
    private IEnumerator MonsterPooling()
    {
        while (true)
        {
